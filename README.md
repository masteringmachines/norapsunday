...
Live demo → (update this link after enabling Pages — see below)
...
Create a new repo on GitHub and push this folder to it (see below).
In the repo, go to Settings → Pages.
Under "Build and deployment", set Source to Deploy from a branch, branch main, folder / (root).
Save — your site will be live at https://YOUR-USERNAME.github.io/REPO-NAME/ within a minute or two.
...
└── .gitignore
Credits
Fonts: Limelight, Poiret One, Playfair Display, IBM Plex Mono (Google Fonts). 3D: Three.js r128 (via cdnjs).
